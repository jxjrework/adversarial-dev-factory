...
from cleverhans_.attacks import MultiModelIterativeMethod
import numpy as np
...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        x_adv = method.generate(x_input, eps=eps, clip_min=-1., clip_max=1., nb_iter=nb_iter)
        ...
        print('unique name headers')
        print(unique_name_headers)
